...
Windows:
(1) Abra o prompt de comando, navegue até os diretórios onde encontram-se os códigos fontes (arquivos .cpp e .h) e makefile, digite make para compilar o programa e criar o arquivo executavel. (Obs: É necessário ter instalado o compilador g++ para que o comando make possa compilar).

(2) Após ter executado o comando make no seu prompt, será criado um arquivo executavel com o nome ep1.
